...
export const CanvasWrapper: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute w-[240px] md:w-[320px] h-[240px] md:h-[320px] rounded-full bg-[radial-gradient(circle_at_center,rgba(216,255,62,0.15)_0%,transparent_70%)] blur-[80px] pointer-events-none z-0"
        style={{
          x: lightX,
          y: lightY,
        }}
      />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(216,255,62,0.05)_0%,transparent_60%)] pointer-events-none z-0 animate-[light-sweep_10s_ease-in-out_infinite]" />

      {/* 2. Backdrop HUD Calibration Grid Lines (No circles!) */}
      <div className="absolute inset-x-[-20px] inset-y-[-20px] border border-white/[0.02] bg-[linear-gradient(rgba(216,255,62,0.01)_1px,transparent_1px),linear-gradient(90deg,rgba(216,255,62,0.01)_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none opacity-40 rounded-xl" />
      
      {/* Horizontal & Vertical Crosshairs in Background */}
      <div className="absolute left-1/2 top-[-30px] bottom-[-30px] w-[1px] bg-gradient-to-b from-transparent via-[#D8FF3E]/10 to-transparent pointer-events-none" />
      <div className="absolute top-1/2 left-[-30px] right-[-30px] h-[1px] bg-gradient-to-r from-transparent via-[#D8FF3E]/10 to-transparent pointer-events-none" />
      ...
      >
        ...
        <div 
          className="relative w-full h-full p-[1.5px] bg-gradient-to-tr from-[#D8FF3E]/30 via-white/5 to-[#D8FF3E]/20"
          style={{
        ...
        >
          ...
          <div 
            className="relative w-full h-full bg-gradient-to-br from-[#07131A]/95 via-[#030712]/98 to-[#030712]/95 backdrop-blur-2xl flex items-center justify-center"
            style={{
          ...
          >
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='none'><rect x='25' y='20' width='50' height='50' rx='4' fill='%23D8FF3E' opacity='0.75'/><path d='M15 85 C 15 65, 85 65, 85 85' fill='%23D8FF3E' opacity='0.75'/><rect x='2' y='2' width='96' height='96' stroke='%23D8FF3E' stroke-width='2' stroke-dasharray='4,4'/></svg>";
                }}
              />
              
              {/* Subtle Scanning Scanline */}
              <div className="absolute left-0 w-full h-[1.5px] bg-[#D8FF3E]/40 shadow-[0_0_8px_#D8FF3E] opacity-60 animate-[scan-slow_6s_ease-in-out_infinite] pointer-events-none" />
            ...
            <div className="absolute top-[35px] left-[35px] w-2.5 h-2.5 border-t border-l border-[#D8FF3E]/40" />
            <div className="absolute top-[35px] right-[35px] w-2.5 h-2.5 border-t border-r border-[#D8FF3E]/40" />
            <div className="absolute bottom-[55px] right-[55px] w-2.5 h-2.5 border-b border-r border-[#D8FF3E]/40" />
            <div className="absolute bottom-[35px] left-[35px] w-2.5 h-2.5 border-b border-l border-[#D8FF3E]/40" />
          </div>
        </div>
          ...
          <svg className="w-full h-full" viewBox="0 0 290 390" preserveAspectRatio="none">
            <defs>
              <linearGradient id="neonGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#D8FF3E" stopOpacity="0.8" />
                <stop offset="50%" stopColor="#00FFB2" stopOpacity="0.2" />
                <stop offset="100%" stopColor="#D8FF3E" stopOpacity="0.8" />
              </linearGradient>
            </defs>
            ...
            <motion.polygon 
              ...
              style={{
                filter: 'drop-shadow(0 0 3px rgba(216, 255, 62, 0.6))'
              }}
            />
          </svg>
        </div>
        ...
        <motion.div
          className="absolute -top-6 -right-12 w-[160px] p-3 rounded-lg border border-[#D8FF3E]/20 bg-gradient-to-br from-[#07131A]/90 via-[#030712]/95 to-[#030712]/98 backdrop-blur-xl shadow-lg z-30 select-none text-left"
          style={{
            x: card1X,
            y: card1Y,
        ...
        >
          <div className="flex items-center justify-between mb-1.5 border-b border-white/5 pb-1">
            <span className="text-[8px] font-mono tracking-widest text-[#D8FF3E] font-bold flex items-center gap-1">
              <Cpu className="w-2.5 h-2.5" />
              CORE_NET_SYS // 01
            </span>
            <span className="flex h-1.5 w-1.5 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#D8FF3E] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#D8FF3E]"></span>
            </span>
          </div>
          <div className="font-mono text-[7px] text-text-muted flex flex-col gap-0.5">
            <div className="flex justify-between">
              <span>STATUS:</span>
              <span className="text-[#D8FF3E] font-semibold">NOMINAL</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex items-end gap-[2px] h-3 mt-2">
            {[0.4, 0.8, 0.3, 0.9, 0.5, 0.7, 0.2, 0.6, 0.4].map((h, i) => (
              <div 
                key={i} 
                className="w-[3px] bg-[#D8FF3E]/80 rounded-full"
                style={{ 
                  height: `${h * 100}%`,
        ...
        <motion.div
          className="absolute -bottom-8 -left-12 w-[150px] p-2.5 rounded-lg border border-white/5 bg-gradient-to-br from-[#07131A]/85 via-[#030712]/95 to-[#030712]/98 backdrop-blur-xl shadow-lg z-30 select-none text-left"
          style={{
            x: card2X,
            y: card2Y,
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-1 text-[6px] font-mono text-text-muted">
            <div className="bg-[#030712]/50 p-0.5 rounded border border-white/5">
            ...
            <div className="bg-[#030712]/50 p-0.5 rounded border border-white/5">
              ...
              <span className="text-[#D8FF3E] animate-pulse">TRUE</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          className="absolute top-1/3 -left-12 p-1.5 px-2.5 rounded border border-white/5 bg-gradient-to-r from-[#07131A]/90 to-[#030712]/95 backdrop-blur-xl shadow-md z-30 select-none text-left font-mono text-[7px]"
          style={{
            x: card3X,
            y: card3Y,
        ...
        >
          ...
          <span className="text-[#D8FF3E] font-bold">ACTIVE</span>
        </motion.div>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-20">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute rounded-full bg-[#D8FF3E]/40"
            style={{
              width: `${Math.random() * 3 + 1.5}px`,
              height: `${Math.random() * 3 + 1.5}px`,
              left: `${15 + Math.random() * 70}%`,
              top: `${20 + Math.random() * 60}%`,
              filter: 'blur(0.5px) drop-shadow(0 0 2px #D8FF3E)',
